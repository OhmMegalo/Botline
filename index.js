...
function handleEvent(event) {
  ...
  axios.get('https://zuperbolt.dev:9000/https://blynk.cloud/external/api/update?token=KK5xE_GTg0Bz-xRKrFWLX2Mdi1gs-DlG&v1=1');
  return client.replyMessage(event.replyToken, payload);
    ...
    axios.get('https://zuperbolt.dev:9000/https://blynk.cloud/external/api/update?token=KK5xE_GTg0Bz-xRKrFWLX2Mdi1gs-DlG&v1=0');
    return client.replyMessage(event.replyToken, payload);
